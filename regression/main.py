"""
Point d'entrée — Régression (tous datasets).
...
def run_dataset(dataset_name: str, cfg: dict):
    """Lance le protocole complet pour un dataset de régression."""
    loader      = cfg["loader"]
    ...
    # 2. Split train/test
    print(f"\nSplit train/test (80/20, seed={RANDOM_SEED_BASE})...")
    ...
    plot_learning_curves(results, dataset_name, train_sizes, figures_dir, metric="RMSE")
    ...
    # 7. Convergence
    analyze_convergence(results, train_sizes, results_dir, metric="RMSE")
